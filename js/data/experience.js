...
window.EXPERIENCE = [
  ...
  },
  {
    ...
    projects: [
      { title: "5S Tooling: Wafer Tray Storage", description: "Designed centralized wafer tray storage to universally store wafer trays of varying sizes.", images: ["assets/experience/qorvo/shelf.jpeg"], skills: ["Solidworks", "DFM", "5S and Lean Manufacturing", "ESD-Safe Material Selection", "Anthropometric Design", "80/20 Fixture Design"], bullets: ["Minimized Cost: Exclusively ESD-compliant thermoplastics (additively manufactured) and off-the-shelf components.", "Designed unit to integrate with the 80/20 system.", "Incorporated stakeholder feedback and anthropometric data to ensure optimal UX touchpoints.", "Reduced friction to locate trays for die-attach processes, thus improving throughput."] },
