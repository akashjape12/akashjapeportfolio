...
window.EXPERIENCE = [
  {
    ...
    projects: [
      ...
      { title: "New Product Ideation", description: "Developed a product pitch and proof-of-concept design for a novel countertop appliance. Conducted initial food science research, culinary experiments, and market studies to present to cross-functional teams.", images: ["assets/experience/sn/Ninja-Logo.jpg"], skills: ["Desirability: Explored current applications of technology across industrial, commercial, and household culinary settings.", "Viability: Assessed market potential, cost implications, and consumer demands.", "Feasibility: Evaluated technical constraints around user safety, regulatory requirements, and assembly complexity."] }
    ]
  },
  {
    id: "Qorvo",
